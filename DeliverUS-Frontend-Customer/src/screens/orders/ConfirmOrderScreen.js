...
export default function ConfirmOrderScreen ({ navigation, route }) {
  ...
  const renderProduct = ({ item, index }) => { //visual del producto
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* FR3 */}
        <ScrollView>
          <TextRegular textStyle={{ color: 'black', fontSize: 14, textAlign: 'center'  }}>
            ¿Quieres confirmar el nuevo pedido?
          </TextRegular>
          <Pressable
            style={({ pressed }) => [
              {
